  ...
  <div style="padding-top: 1rem">
    <div class="container" style="border: 1px solid gray">
      ...
      <div class="fl">
        <div
          class="capsule"
          v-for="(i, j) in cat3333"
          :key="j"
          @click="transmission71(i)"
        >
          <span>{{ i }}</span>
        </div>
      </div>
      <p v-if="model.subcategory == 'Spare Parts'">owner Type</p>
      <div class="fl" v-if="model.subcategory == 'Spare Parts'">
        <div
          class="capsule"
          v-for="(i, j) in onwtype"
          :key="j"
          @click="transmission12(i)"
        >
          <span>{{ i }}</span>
        </div>
      </div>

      <p v-if="model.subcategory == 'Spare Parts'">KM Driven</p>
      <el-input
        v-if="model.subcategory == 'Spare Parts'"
        style="width: 21%"
        placeholder="Enter KM driven"
        v-model="model.kmdriven"
      ></el-input>
      <p>State</p>
      <el-input
        style="width: 21%"
...
export default {
  ...
  methods: {
    ...
    transmission71(e) {
      var self = this;
      self.model.transmission = e;
    },
    transmission10(e) {
      var self = this;
      self.model.bachelor = e;
    },
    ...
    async getData4() {
      var self = this;
      let acat2 = [];
      self.category = "Commercial Vehicles";
