  ...
  <div style="padding-top: 1rem">
    <div class="container" style="border: 1px solid gray">
      ...
      <el-input
        ...
        v-model="model.breadth"
      ></el-input>
      <p>Plot Area</p>
      <el-input
        style="width: 21%"
        placeholder="Enter plot area"
        v-model="model.plot_area"
      ></el-input> -->
      <p>Car Parking</p>
      <div class="fl">
        <div
      ...
      <button class="btn" @click="firstFormSubmit">Post Now</button>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    transmission8(e) {
      var self = this;
      self.model.washroom = e;
    },
    transmission9(e) {
      var self = this;
      self.model.meals_included = e;
    },
