<template>
  <div>
    <div class="imgsection">
      <img
        :src="adbanner"
        style="width: 100%; aspect-ratio: 2/1; height: 100%; object-fit: cover"
      />
    </div>
            ...
            <div style="height: 9rem; overflow-y: scroll">
              ...
              <div>
                ...
                <p
                  ...
                  :key="j"
                  @click="filter1(i.subcategory)"
                >
                  <span :class="{ highlighted: filtercat === i.subcategory }">
                    {{ i.subcategory }}</span
                  >
                </p>
              </div>
              ...
              <div>
                ...
                >
                  <p
                    class=""
                    @click="filter4(3)"
                    :class="{ highlighted: filtercat4 === 3 }"
                  >
                    5 + Year
                  </p>
                </span>
...
export default {
  ...
  methods: {
    ...
    async getData() {
      ...
      self.filterdata = await db.collection("Category").getOne(`${id}`, {});
      this.getData22();
    },
    async getData22() {
      var self = this;
